...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='./results/sample01')
    ...
    otsu_adaptive(img, ref, img_name, output_dir, "vertical")
    regression(img, ref, img_name, output_dir, "vertical")
